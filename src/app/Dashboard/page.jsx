...
//         // نگاشت پرمیشن‌ها به ساختار منو با پشتیبانی از زیرمنوها
//         const menuItems = permissions
//           .filter((perm) => perm.parentPermissionId === null && perm.isActive)
//           .map((perm) => ({
//             icon: <FaThLarge />,
//             label: perm.name,
//             link: "#",
...
//               .filter(
//                 (subPerm) =>
//                   subPerm.parentPermissionId === perm.id && subPerm.isActive
//               )
//               .map((subPerm) => ({
//                 label: subPerm.name,
//                 link: "#",
...
//         setMenu(menuItems);
//       } catch (error) {
//         console.error("خطا در دریافت داده‌های منو:", error);
//         setMenu([{ icon: <FaThLarge />, label: "پیشخوان", link: "#" }]);
//       }
//     };
...
//     setOpenSub((prev) => ({ ...prev, [idx]: !prev[idx] }));
//   };
...
//               <div key={idx}>
//                 <button
//                   className="w-full flex items-center gap-3 py-2 px-3 rounded-lg hover:bg-[#2d2e4a] transition focus:outline-none justify-between flex-row-reverse"
//                   onClick={() => (item.sub ? handleSubMenu(idx) : null)}
//                 >
...
//                     ))}
//                 </button>
//                 {item.sub && item.sub.length > 0 && openSub[idx] && (
//                   <div className="flex flex-col gap-1 pl-8 mt-1">
//                     {item.sub.map((sub, subIdx) => (
//                       <a
//                         key={subIdx}
//                         href={sub.link}
//                         className="py-1 px-2 rounded hover:bg-[#35365a] text-sm text-gray-200 transition flex items-center justify-end gap-2 flex-row-reverse"
//                       >
//                         <span>{sub.label}</span>
...
//         </div>
//         <button
//           className="flex items-center gap-2 justify-center bg-[#23243a] border border-gray-700 rounded-lg py-2 mt-8 text-gray-300 hover:bg-[#2d2e4a] transition flex-row-reverse"
...
//             <span className="font-bold">سعید محمدی</span>
//             <img
...
//             <h2 className="text-xl font-bold mb-2">آمار بازدید و فروش</h2>
    ...
    <div className="min-h-screen flex bg-[#f3f7fa] flex-row-reverse">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <main className="flex-1 flex flex-col md:flex-row gap-8 p-4 md:p-8">
          {/* Chart */}
          <div className="flex-1 bg-white rounded-xl shadow p-6 flex flex-col items-center justify-center">
            <h2 className="text-xl font-bold mb-2 text-black">آمار بازدید و فروش</h2>
